...
const players = [
  { name: "Ibrahim Musa", level: 4, xp: 9820, quests: 28, raids: 6, change: 0, badge: "Architect", location: "Abuja" },
  { name: "Chinwe Eze", level: 4, xp: 9540, quests: 27, raids: 6, change: 1, badge: "Vector Sage", location: "Lagos" },
  { name: "Tunde Adeyemi", level: 4, xp: 9210, quests: 25, raids: 5, change: -1, badge: "Prompt Smith", location: "Ikeja" },
  { name: "Fatima Bello", level: 3, xp: 8740, quests: 24, raids: 5, change: 2, badge: "Data Hunter", location: "Abuja" },
  { name: "Emeka Okonkwo", level: 3, xp: 8390, quests: 23, raids: 5, change: 0, badge: "Pipeline Pro", location: "Ikeja" },
  { name: "Aisha Lawal", level: 3, xp: 7980, quests: 22, raids: 4, change: 3, badge: "RAG Crafter", location: "Lagos" },
  { name: "Segun Olatunji", level: 3, xp: 7620, quests: 20, raids: 4, change: -2, badge: "Fine-Tuner", location: "Abuja" },
  { name: "Ngozi Ugo", level: 3, xp: 7340, quests: 19, raids: 4, change: 1, badge: "Eval Master", location: "Ikeja" },
  { name: "Yusuf Garba", level: 2, xp: 6980, quests: 18, raids: 3, change: 0, badge: "Deployer", location: "Lagos" },
  { name: "Blessing John", level: 2, xp: 6720, quests: 17, raids: 3, change: 4, badge: "Notebook Ninja", location: "Abuja" },
  { name: "Kelvin Ade", level: 2, xp: 6510, quests: 16, raids: 3, change: -1, badge: "API Forger", location: "Ikeja" },
  { name: "Halima Sani", level: 2, xp: 6280, quests: 15, raids: 2, change: 0, badge: "Embed Sensei", location: "Lagos" },
  { name: ME, level: 2, xp: 2480, quests: 12, raids: 2, change: 6, badge: "Vector Initiate", location: "Ikeja" },
];

const LeaderboardProgram = () => {
  const scope = "program";
    ...
    <div className="space-y-6 animate-fade-up">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="font-display text-3xl lg:text-4xl font-bold">Program Leaderboard</h1>
      ...
      <div className="relative overflow-hidden glass-panel rounded-2xl p-5 lg:p-6">
        ...
        <div className="relative grid md:grid-cols-3 gap-5 items-center">
          ...
          <div>
            ...
            <Button variant="hero" size="sm" className="mt-3 gap-1" onClick={() => navigate("/dashboard/quests")}>Take a quest <Sparkles className="h-3.5 w-3.5" /></Button>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="col-span-5 flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-muted-foreground truncate">{p.badge} • {p.location}</p>
                </div>
              </div>
...
export default LeaderboardProgram;
